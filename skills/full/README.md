...
- 如果你想先快速判断“这是不是我要的”，建议先回到 [`../README.md`](../README.md) 看中文技能卡片。
- 如果你想直接看 skill 的正文，就进入对应目录，优先读 `SKILL.md`。
- 如果你更关心 GitHub 浏览体验，可以把这里理解成“当前公开版完整 skill 包目录”。
...
- 这一级目录更适合直接打开 skill 正文来看，而不是只看目录名。
- 有些 skill 未来可能继续打磨，并在条件成熟后拆成更适合单独传播的独立仓。
- 如果你只是想先抓主要脉络，建议从 [`../README.md`](../README.md) 或 [`../README.en.md`](../README.en.md) 开始。
